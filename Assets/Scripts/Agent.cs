...
public class Agent : MonoBehaviour
{
   ...
   */
  {
    while (true)
    {
      ...
      switch (state)
      {
        ...
        case "reset":
          {
            // set the response with the initial observation of the environment
            reset_response = new ResetResponse
            {
              observation = get_observation(),
              init_ball_pos = BALL.GetComponent<Ball>().OneHotStartPos
            };
   ...
   */
  {
    ...
    step_response.init_ball_pos = BALL.GetComponent<Ball>().OneHotStartPos;
   ...
   */
  {
    Debug.Log($"Agent.cs::get_observation");
